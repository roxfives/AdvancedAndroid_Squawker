...
public class FollowingPreferenceFragment
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String s) {
        Preference mPreferece = findPreference(s);

        if(mPreferece != null && mPreferece instanceof SwitchPreferenceCompat) {
            boolean isFollowing = sharedPreferences.getBoolean(s, false);
            if(isFollowing) {
